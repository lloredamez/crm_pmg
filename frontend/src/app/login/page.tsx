...
import { Zap, ShieldCheck, UserCheck, Headset, Lock, Mail, ArrowRight } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const handleQuickLogin = async (demoEmail: string) => {
    ...
    setLoading(true);
    try {
      await login(demoEmail, 'senha123');
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-slate-50/70 flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Lead CRM System</h1>
        ...
        <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-xl shadow-slate-200/50">
          ...
          <p className="text-xs text-slate-400 mb-6">Informe suas credenciais para gerenciar seus atendimentos</p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="email"
                  required
                  placeholder="seu.email@crmleads.com"
                  value={email}
          ...
          <div className="mt-8 pt-6 border-t border-slate-100">
            ...
            <div className="space-y-2">
              <button
                type="button"
                onClick={() => handleQuickLogin('admin@crmleads.com')}
              ...
              >
                ...
                <span className="text-[10px] text-slate-400">admin@crmleads.com</span>
              </button>
              ...
              <button
                type="button"
                onClick={() => handleQuickLogin('ana.silva@crmleads.com')}
                className="w-full bg-slate-50 hover:bg-brand-50 border border-slate-200 hover:border-brand-200 rounded-2xl p-2.5 text-xs font-medium text-slate-700 flex items-center justify-between transition-colors"
              >
                <div className="flex items-center gap-2">
